...
-- External search-interest analytics (migration 022).
...
-- Mining software observations (migration 023); run backfill before reads.
...
CREATE INDEX IF NOT EXISTS block_software_category_height_idx ON public.block_software(software, height);
...
-- Fresh databases include migration 026.
